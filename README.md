...
**Author:** Sajjad  
**Contact:** sajjadmv72@gmail.com
**Organization:** University of Oulu
**Website:** https://github.com/Reproducible workflow for hydropower regulation and data analysis/hydroreg_oulujoki

## Project Overview
Reproducible workflow for hydropower regulation and data analysis
...
Sajjad (2026).
*HydroReg Oulujoki* (Version 0.1.0).
University of Oulu.
DOI: 
...
```bibtex
@software hydroreg_oulujoki,
  author = Sajjad,
  title = HydroReg Oulujoki,
  year = 2026,
  version = 0.1.0,
  doi = ,
  url = https://github.com/Reproducible workflow for hydropower regulation and data analysis/hydroreg_oulujoki
}
```
or
